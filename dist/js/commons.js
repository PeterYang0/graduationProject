...
var _hogan = __webpack_require__(14);
...
var mm = {
	...
	renderHtml: function renderHtml(templateHtml, data) {
		var tem = _hogan2.default.compile(templateHtml),
		    result = tem.render(data);
		return result;
	},
	successTips: function successTips(res) {
		alert(res || '操作成功');
	},
	...
	//字段的验证 支持非空，手机，邮箱
	validata: function validata(value, type) {
		var value = _jquery2.default.trim(value);
		if (type === 'require') {
...
var _user = {
    // 用户登录
    login: function login(userInfo, resolve, reject) {
        _mm3.default.request({
            url: '/api/user/login',
            data: userInfo,
            method: 'POST',
            success: resolve,
    ...
    //检查是否为管理员
    isAdmin: function isAdmin(username, resolve, reject) {
        _mm3.default.request({
    ...
    // 用户注册
    register: function register(userInfo, resolve, reject) {
        _mm3.default.request({
            url: _mm3.default.getServerUrl('/user/register.do'),
            data: userInfo,
            method: 'POST',
            success: resolve,
            error: reject
    ...
    logout: function logout(resolve, reject) {
        _mm3.default.request({
            url: _mm3.default.getServerUrl('/user/logout.do'),
            method: 'POST',
            success: resolve,
            error: reject
        });
   ...
   * @Last Modified by:   羊驼
   * @Last Modified time: 2018-12-26 17:53:21
   */
